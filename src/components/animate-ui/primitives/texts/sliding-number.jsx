...
function SlidingNumber({
  ...
  const prevNumberRef = React.useRef(initiallyStable ? initialNumeric : 0);
  ...
  const [effectiveNumber, setEffectiveNumber] = React.useState(initiallyStable ? initialNumeric : 0);
